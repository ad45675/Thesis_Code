...
InitialPose=[0,0,180]
InitialPosition=[0.4962, -0.0054, 0.05]

[invsol1, flag,Singularplace] = IK.InverseKinematics(InitialPose, InitialPosition, DH_table)
...
joint3 = [0.10073966 ,-0.84049473 ,-0.26748301, 0.         ,-0.46281859,  0.10073966]
Info, EulerAngle_vrep, EulerAngle1, Position1 = FK.ForwardKinemetics(joint3, DH_table)
print("Position1",Position1,"EulerAngle1",EulerAngle1)

optimalsol1=FindOptSol(invsol1,JointAngle1,Singularplace)
Info, EulerAngle_vrep, EulerAngle1, Position1 = FK.ForwardKinemetics(optimalsol1, DH_table)
...
InitialPose=[0,0,180]
InitialPosition=[0.5453, -0.0, 0.705]

[invsol1, flag,Singularplace] = IK.InverseKinematics(InitialPose, InitialPosition, DH_table)
[invsol2, flag,Singularplace] = IK.InverseKinematics(FinalPose , FinalPosition , DH_table)

optimalsol1=FindOptSol(invsol1,JointAngle1,Singularplace)
optimalsol2=FindOptSol(invsol2,JointAngle2,Singularplace)
