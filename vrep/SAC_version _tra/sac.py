...
class SAC_agent(object):
    ...
    def learn(self):
        ...
        # value_target = critic_value - log_probs  #(版1)
        value_target = critic_value - self.scale * log_probs  #(版2)
        ...
        # actor_loss=log_probs-critic_value #(版1)
        actor_loss = self.scale * log_probs - critic_value  #(版2)
